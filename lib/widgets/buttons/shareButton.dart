    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          ...
          BoxShadow(color: color.withOpacity(0.09), offset: Offset(-4.0, -4.0), blurRadius:  isDesktop?10:2, spreadRadius: 1.0),
        ],
        gradient: gradient,
      ),
      child: IconButton(
        icon: FaIcon(icon, color: color),
        onPressed: onPressed, tooltip: tip, splashRadius: isDesktop ? 10 : 20,
      ),
    );
  }
}
