...
class _SuccinctState extends State<Succinct> {
  ...
  Widget build(BuildContext context) {
    ...
    final bodyTextStyle = textTheme.bodyText1.apply(fontFamily: 'Amiri', heightDelta: 1.8);
    final bodyTextStyle2 = textTheme.headline5.apply(fontFamily: 'Amiri', heightDelta: 1.8);
    final txtStyle = textTheme.headline6.copyWith(fontFamily: 'Amiri', fontStyle: FontStyle.italic, decoration: TextDecoration.underline, fontSize: 18, fontWeight: FontWeight.bold);
    return Scaffold(
