...
class SpUtil {
  ...
  static Future<bool> setFullScreen(bool value) => appSP.setBool(fullScreen, value);
  static Future<bool> setDarkTheme(bool value) => appSP.setBool(isDarkMode, value);
  static Future<bool> setFont(String value) => appSP.setString(fontFamily, value);
  static Future<bool> setFontSize(double value) => appSP.setDouble(fontSize, value);
}
